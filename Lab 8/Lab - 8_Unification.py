# -*- coding: utf-8 -*-
"""
Created on Fri Dec 11 09:46:19 2020
...
def chk_arg_pred():
    pred_flag = 0
    arg_flag = 0
    for i in range(no_of_pred-1):        #To check predicates
    ...
    if(pred_flag != 1):                 #Checking number of arguments
        ind = 0
        key = no_of_arg[ind]
        l = len(no_of_arg)
